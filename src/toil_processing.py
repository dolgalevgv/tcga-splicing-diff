...
toil_index = pd.read_csv('../data/raw/toil_tcga_target_gtex_rsem_260422', sep='\t', usecols=[0,1])
...
toil_data = pd.read_csv('../data/raw/toil_tcga_target_gtex_rsem_260422', sep='\t', skiprows=lambda x: x not in trs_uniprot_toil_indices)
